...
def test_delete_vote_post_nonexist(authorized_client, test_posts):
    res = authorized_client.post("/vote/", json={"post_id": 888888888888, "dir": 1})
    assert res.status_code == 404


def test_vote_unauth(client, test_posts):
